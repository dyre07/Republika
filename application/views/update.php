      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url('admin/update_proccess')?>" enctype="multipart/form-data">
			  <div class="box-body">
                  <input type="hidden" name="id_berita" value="<?php echo $update->id_berita?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                      <textarea class="form-control" name="content"><?php echo $update->content;?></textarea>
                  </div>
                </div>
              ...
              <div class="box-footer">
                <button class="btn btn-default"><a href="<?php echo base_url();?>">Batal</a></button>
